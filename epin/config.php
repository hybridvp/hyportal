...
if (!isset($path_to_root) || isset($_GET['path_to_root']) || isset($_POST['path_to_root']))
	...
	// Main Title
	$app_title = "Simplex EPIN Management System";
	// application version
	$version 		= "2.2.5";
	...
	// Powered by
	$power_by 		= "Etisalat Nigeria";
	$power_url 		= "http://www.etisalat.com.ng ";
	...
	/* use Audit Trails in all Screens */
	$nonfin_audit_trail = 1;
	...
	$print_invoice_no = 1;  ///if 1 then reports print SO number instead of ref number:
...
if (!defined('ICON_EDIT'))
{
	...
	$use_ldap = 1;
	$min_range_value = 10;
	/* allow scrolling of reorder levels that have been reached */
	$scroll_reorder_levels = 0;
	define("PIN_PATH", $comp_path.'/'.user_company()."/pinmailer/");
	define("RAWPIN_IN_PATH", $comp_path.'/'.user_company()."/rawpin/");
	define("DEALERKEY_PATH", $comp_path.'/'.user_company()."/dealer_keys/");
	define("ACTIVATION_PATH", $comp_path.'/'.user_company()."/activation/");
	define("DB_HOST",'10.160.161.26');
	define("DB_USER",'oracle');
	define("DB_PASS",'sys123');
	define("APP_NAME",'epin');
