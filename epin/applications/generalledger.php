...
class general_ledger_app extends application 
{
	function general_ledger_app() 
	{
		...
		$this->add_rapp_function(0, _("&Budget Entry"),
			"simplex/gl/gl_budget.php?", 'SA_BUDGETENTRY');
...
///-----------------------------------------------------------------------------
///Added new menu for account analysis code types //////////////////////////////

///-----------------------------------------------------------------------------
		$this->add_rapp_function(2, "","");

		$this->add_rapp_function(2, _("GL Account &Analysis Types"),
			"simplex/gl/manage/acct_analysis_types.php?", 'SA_GLACCOUNTCLASS');
