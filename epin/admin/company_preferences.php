	...
	if ($input_error != 1)
	{
		update_company_setup($_POST['coy_name'], $_POST['coy_no'], 
			...
			$_POST['delivery_subject'], $_POST['delivery_body'] , check_value('alert_reorder_level'),
			 $_POST['alert_repeat'], $_POST['default_delivery_required'], $_POST['maillist'], $_POST['support'] );
...
$_POST['support']  = $myrow["support_maillist"];
...
so_mailing_list_row('Support Mailing List', 'support', $_POST['support'], ST_SALESORDER);
table_section(2);
