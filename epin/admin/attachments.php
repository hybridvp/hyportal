...
if ($Mode == 'ADD_ITEM' || $Mode == 'UPDATE_ITEM')
{
	...
	if ($Mode == 'ADD_ITEM')
	{
		$sql = "INSERT INTO ".TB_PREF."attachments (id,type_no, trans_no, description, filename, unique_name,
			filesize, filetype, tran_date) VALUES (ATTACHMENTS_ID_SEQ.NEXTVAL,".db_escape($_POST['filterType']).","
