...
if ($Mode=='ADD_ITEM' || $Mode=='UPDATE_ITEM') 
{
	...
	if ($inpug_error != 1)
	{
    	...
    	else 
    	{
    		...
    		if (check_value('DaysOrFoll')) 
    		{
    			$sql = "INSERT INTO ".TB_PREF."payment_terms (TERMS_INDICATOR,terms,
					days_before_due, day_in_following_month)
					VALUES (PAYMENT_TERMS_INDICATOR_SEQ.NEXTVAL," .
    		...
    		else 
    		{
    			$sql = "INSERT INTO ".TB_PREF."payment_terms (TERMS_INDICATOR,terms,
					days_before_due, day_in_following_month)
					VALUES (PAYMENT_TERMS_INDICATOR_SEQ.NEXTVAL," . db_escape($_POST['terms']) . ",
