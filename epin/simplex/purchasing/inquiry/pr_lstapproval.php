...
page(_($help_context = "Search Outstanding Purchase Requisition"), false, false, "", $js);
...
{
  return pager_link( _("Approve to Purchase Requisition"),
	"/simplex/purchasing/view/pr_approval.php?" . SID 
	. "trans_no=" . $row["pr_no"], ICON_EDIT);
}
...
$sql = "SELECT 
	...
	AND (porder.status = 'Pending' or porder.status = 'Planned')";
