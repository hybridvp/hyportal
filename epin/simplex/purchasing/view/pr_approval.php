...
page(_($help_context = "Forward/Approve Purchase Requisition"), true, false, "", $js);
...
*/
 if (isset($_POST['ForwardOrder']))
  ...
  //Display_notification ("Updating next approval to ". $_POST['next_approver']) ;
  //return ;
 //Test if the current authoriser 
//    display_notification( "Authorising Purchase Req ".$_REQUEST['approver_status1']) ;
/*    approve_pr ( $_POST['trans_no'], $_POST['next_approver'],  $_POST['approver_status1'],  
					$_POST['approver_status2'],  $_POST['approver_status3'],$_POST['items_total']);
	
    if (can_authorise($_POST['trans_no'], $_POST['approved_by1'], $_POST['items_total'], null) && 
			can_authorise($_POST['trans_no'], $_POST['approved_by1'], $_POST['items_total'], null))
			//display_notification( "Authorising Purchase Req ".$_POST['approved_by1']) ;
    if (can_approve($_POST['trans_no'], $_POST['approved_by1'], $_POST['items_total']))
         // display_notification( "Authorising Purchase Req ".$_POST['approved_by1']) ;
*/	
	// return ;
   }	
