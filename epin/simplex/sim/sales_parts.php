...
if ($Mode == 'Delete')
{
	...
	if ((db_num_rows($kit) == 1) && $num_kits) {
		...
		$msg = _("This item cannot be deleted because it is the last item in the kit used by following sales parts")
			.':<br>';
...
echo sales_kits_list('item_code', null, _('New Sales part'), true);
echo "</center><br>";
$props = get_kit_props($_POST['item_code']);
...
} else
{
	...
	submit_row('update_name', _("Update"), false, 'align=center colspan=2', _('Update sales part name'), true);
	end_row();
	end_table(1);
