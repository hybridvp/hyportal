...
page(_($help_context = "Receive from Transit to Store"), false, false, "", $js);
...
locations_list_cells(_("To Location:"), 'StockLocation', null, true);
...
$sql = "SELECT 
	...
	stock.reference
	FROM "
		.TB_PREF."stock_moves_transit stock, "
