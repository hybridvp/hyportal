...
page(_($help_context = "Customers Contract Terms"), @$_REQUEST['popup']); 
...
//////////////////////////////////////////////////////////////////////////// 
	...
	{ 	//it is a new customer request 
		$sql = "INSERT INTO ".TB_PREF."debtors_terms_requests (debtor_no, name, debtor_ref, address, tax_id, email, 
			...
			sales_type, notes, request_id, requested_by, created_date, version,last_updated_by, last_updated_date) 
		   ...
		   .",DEBTORS_TERMS_REQUESTS_SEQ.NEXTVAL, ".db_escape($_SESSION['wa_current_user']->loginname).",sysdate,0,"
