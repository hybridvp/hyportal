...
function dispatch_link($row)
{
	global $trans_type;
	//if ($trans_type == ST_SALESORDER)
  		return pager_link( _("Pick Items"),
			"/simplex/sales/so_pick_serialize.php?OrderNumber=" .$row['order_no'], ICON_DOC);
	//else		
...
$sql = "SELECT 
		...
		sorder.deliver_to,
		line.unit_price*line.quantity*(1-line.discount_percent)+freight_cost AS ordervalue,
		sorder.type_,
		debtor.curr_code,
