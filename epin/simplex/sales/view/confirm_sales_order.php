  ...
  if (isset($_POST['ConfirmOrder']))
  {
	 ...
	 {	if (confirm_sales_order ($customer_id, $order_no, $trans_type, $amount, $current_state, $credit_limit)) 
		{	
			...
			//$body = $myrow["msg_body"];
			$body = get_company_pref("confirm_msg_body");
			$subject = get_company_pref("confirm_msg_subject");
			...
			if($nonfin_audit_trail)
			{
				...
				add_nonfin_audit_trail(0,0,0,0,'SALES ORDER CONFIRMATION','A',$ip,'SALES ORDER # %d ' . $order_no. " CONFIRMED ");
			}
