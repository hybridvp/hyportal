 ...
 */
  ...
  /* Uncomment when using SASL authentication mechanisms */
	...
	*/
	...
	$from="lolapegba@bluechiptech.biz";                           /* Change this to your address like "me@mydomain.com"; */ $sender_line=__LINE__;
	$to="lolapegba@bluechiptech.biz";                             /* Change this to your test recipient address */ $recipient_line=__LINE__;
	...
	$smtp->host_name="mail.@bluechiptech.biz";       /* Change this variable to the address of the SMTP server to relay, like "smtp.myisp.com" */
	...
	$smtp->localhost="mail.@bluechiptech.biz";       /* Your computer address */
