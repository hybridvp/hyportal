...
$th = array(_("Item Code"), _("Item Description"), _("Cost Centre"), _("Quantity"), _("Unit"),
	 _("Requested By"), _("Quantity Received"), _("Quantity Invoiced"));
table_header($th);
$total = $k = 0;
$overdue_items = false;
...
//label_row(_("Total Excluding Tax/Shipping"), $display_total,	"align=right colspan=5", "nowrap align=right", 3);
