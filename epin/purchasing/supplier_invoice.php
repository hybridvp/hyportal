...
//--------------------------------------------------------------------------------------------------
function get_order_no($po_detail_item)
{
		$sql2 = "SELECT order_no from "
...
//add_stock_move(ST_SUPPRECEIVE, $myrow["item_code"], $myrow['grn_batch_id'], $grn['loc_code'], sql2date($grn["delivery_date"]), "",
	 //  		-$myrow["QtyOstdg"], $myrow['std_cost_unit'], $grn["supplier_id"], 1, $myrow['unit_price']);
				   ...
				   /*	add_stock_move(ST_SUPPRECEIVE, $myrow["item_code"], $myrow['grn_batch_id'], $grn['loc_code'], sql2date($grn["delivery_date"]), "",	   		-$myrow["QtyOstdg"], $myrow['std_cost_unit'], $grn["supplier_id"], 1, $myrow['unit_price'],0,"",
			get_order_no($myrow['po_detail_item']);*/
			//Laolu added ,0,"",get_order_no(.$myrow['po_detail_item'
	   	commit_transaction();
