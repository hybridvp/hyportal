...
//			add_js_ufile("themes/default/renderer.js");
		...
		{
			global $path_to_root, $help_base_url, $db_connections, $scroll_reorder_levels;
			...
			if (!$no_menu)
			{
				...
				echo "<tr><td><marquee style='margin:5px 40px; background-color:#000; color:#fff' direction='left' scroldelay='250' onmouseover='this.stop()' onmouseout='this.start()'>";
				//the text for the reorder level here
				//$alert = get_company_pref('alert_reorder_level');
				if ($scroll_reorder_levels )
				{
					echo user_notifications(); //"Reorder Level quantity here";
				}
				echo "</marquee></td></tr>";
				echo "<tr><td>";
				echo "<div class=tabs>";
