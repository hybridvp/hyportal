...
{
	$sql = "SELECT a.order_no, a.line_no, a.status,b.start_serial, b.end_serial, file_gen_date dispatch_time,
			job_status, to_date( uvc_submit_time,'DDMMYYYYHH24:MI:SS') uvc_submit_time,  to_date( uvc_start_time,'DDMMYYYYHH24:MI:SS') uvc_start_time ,
			to_date( uvc_finish_time,'DDMMYYYYHH24:MI:SS') uvc_finish_time
			FROM "
...
$th = array(_("Item Code"), _("Item Desc"), _("Qty"), _("Unit"),
	_("Qty Dispatched"));  //_("Price"), _("Discount"), _("Total"), 
table_header($th);
