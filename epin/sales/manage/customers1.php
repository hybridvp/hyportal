...
function handle_submit()
{
	...
	{ 	//it is a new customer
		...
		begin_transaction();
		//$_POST['customer_id'] = db_insert_id(""); customer id should be passed from the front end
		...
		$sql = "INSERT INTO ".TB_PREF."debtors_master (debtor_no, name, debtor_ref, address, tax_id, email, dimension_id, dimension2_id,  
			...
			sales_type, notes) VALUES (".db_escape($_POST['customer_id']) .", " .db_escape($_POST['CustName']) .", " 
