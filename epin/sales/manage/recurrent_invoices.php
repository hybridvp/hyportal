...
if ($Mode=='ADD_ITEM' || $Mode=='UPDATE_ITEM') 
{
	...
	{
		$input_error = 1;
		display_error(_("A template must be created first."));
		set_focus('order_no');
	}
	...
	if ($input_error != 1)
	{
    	...
    	{
    		$sql = "INSERT INTO ".TB_PREF."recurrent_invoices (id,description, order_no, debtor_no,
    			group_no, days, monthly, begin, end, last_sent) VALUES (RECURRENT_INVOICES_ID_SEQ.NEXTVAL,".db_escape($_POST['description']) . ", "
