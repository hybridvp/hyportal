...
page(_($help_context = "Dealer Transactions"), false, false, "", $js);
...
//			(trans.ov_amount + trans.ov_gst + trans.ov_freight + trans.ov_freight_tax + trans.ov_discount))) , ";
		...
		case when ((trans.type = ".ST_SALESINVOICE.")
			AND trans.due_date < '" . date2sql(Today()) . "') then 1 else 0 end AS OverDue
		FROM "
