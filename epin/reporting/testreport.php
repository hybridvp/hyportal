...
$_POST['PARAM_1'] = "NGN";
$_POST['PARAM_2'] = 0 ;
$_POST['PARAM_3'] = "This is a test report";
...
function getTransactions($debtorno, $date)
{
    $sql = "SELECT ".TB_PREF."debtor_trans.*,
				...
				case when ".TB_PREF."debtor_trans.type = ".ST_SALESINVOICE."
					AND ".TB_PREF."debtor_trans.due_date < to_date('$date','yyyy-mm-dd') then 1 else 0 end AS OverDue
    			FROM ".TB_PREF."debtor_trans
    			WHERE ".TB_PREF."debtor_trans.tran_date <= to_date('$date','yyyy-mm-dd') AND ".TB_PREF."debtor_trans.debtor_no = ".db_escape($debtorno)."
...
function print_statements()
{
	...
	$sql = "SELECT debtor_no, name AS DebtorName, address, tax_id, email, curr_code, trunc(sysdate) AS tran_date, payment_terms FROM ".TB_PREF."debtors_master";
