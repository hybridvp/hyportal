...
//".TB_PREF."stock_master.material_cost + ".TB_PREF."stock_master.labour_cost + ".TB_PREF."stock_master.overhead_cost AS unitcost,
	$sql = "SELECT ".TB_PREF."stock_master.category_id,
	  ...
	  ".TB_PREF."pin_mailer_jobs.sold_from_loc as location,
	  	    SUM(".TB_PREF."pin_mailer_jobs.denomination/denomination) as QtyOnHand,
		...
		//if ($location != 'all')
			$sql .= TB_PREF."pin_mailer_jobs.sold_from_loc, ";
		$sql .= "stock_master.facevalue,
			".TB_PREF."stock_master.stock_id,
			".TB_PREF."stock_master.description,
			".TB_PREF."pin_mailer_jobs.denomination
		HAVING SUM(".TB_PREF."denomination/denomination) != 0";
		if ($category != 0)
			$sql .= " AND ".TB_PREF."stock_master.category_id = ".db_escape($category);
		//if ($location != 'all')
		//	$sql .= " AND ".TB_PREF."pin_mailer_jobs.location = ".db_escape($location);
...
//".TB_PREF."stock_master.material_cost + ".TB_PREF."stock_master.labour_cost + ".TB_PREF."stock_master.overhead_cost AS unitcost,
	$sql = "SELECT ".TB_PREF."stock_master.category_id,
			...
			".TB_PREF."stock_master.stock_id,
			".TB_PREF."stock_master.description,
	  trunc(".TB_PREF."pin_mailer_jobs.logged_date) as date_,
			".TB_PREF."stock_master.facevalue AS unitcost,
		...
		GROUP BY ".TB_PREF."stock_master.category_id,
			".TB_PREF."stock_category.description, ";
		//if ($location != 'all')
			$sql .= "trunc(" .TB_PREF."pin_mailer_jobs.logged_date), ";
		$sql .= "stock_master.facevalue,
			".TB_PREF."stock_master.stock_id,
			".TB_PREF."stock_master.description,
			".TB_PREF."pin_mailer_jobs.denomination
...
function print_inventory_valuation_report()
{
    ...
    $rep = new FrontReport(_('Daily Sales Report'), "DailySalesReport", user_pagesize());
