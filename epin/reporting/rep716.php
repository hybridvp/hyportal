...
cod_key1_value,cod_key2_value
		FROM ".TB_PREF."audit_trail_nonfin a ,"
		      .TB_PREF."users u 
		WHERE 1=1 
		AND cod_trans_type ='PIN INQUIRY'
...
function print_audit_trail()
{
    ...
    $headers = array(_('Date'), _('Time'), _('User'),
    	_('Trans Type'), _('Description'), _('Terminal ID'), _('SERIAL'),  _('PIN'));
    ...
    $rep = new FrontReport(_('PIN Enquiry Activity Report'), "PINEnquiry", user_pagesize());
...
//        $rep->TextCol(6, 7, $myrow['action']);
		$rep->TextCol(6, 7, $myrow['cod_key1_value']);
		$rep->TextCol(7, 8, $myrow['cod_key2_value']);
