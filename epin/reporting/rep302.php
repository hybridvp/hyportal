...
function getTransactions($category, $location)
{
	$sql = "SELECT ".TB_PREF."stock_master.category_id,
			...
			DECODE(".TB_PREF."pin_details.stock_id , NULL, ' ', ".TB_PREF."pin_details.location) AS loc_code,
			SUM(DECODE(".TB_PREF."pin_details.stock_id , NULL,0,".TB_PREF."(pin_details.facevalue/pin_details.facevalue ))) AS qty_on_hand
		FROM ".TB_PREF."stock_master,
			".TB_PREF."stock_category, 
		".TB_PREF."pin_details WHERE 1=1 
			AND ".TB_PREF."stock_master.stock_id(+) =".TB_PREF."pin_details.stock_id  " //OR ".TB_PREF."stock_master.stock_id IS NULL)
		. " AND ".TB_PREF."stock_master.category_id=".TB_PREF."stock_category.category_id
		AND (".TB_PREF."stock_master.mb_flag='B' OR ".TB_PREF."stock_master.mb_flag='M')";
	if ($category != 0)
		$sql .= " AND ".TB_PREF."stock_master.category_id = ".db_escape($category);
	if ($location != 'all')
		$sql .= " AND IF(".TB_PREF."pin_details.stock_id IS NULL, '1=1',".TB_PREF."pin_details.location = ".db_escape($location).")";
	$sql .= " GROUP BY ".TB_PREF."stock_master.category_id,
		".TB_PREF."stock_category.description,
		".TB_PREF."stock_master.stock_id,
		".TB_PREF."stock_master.description ,
		decode(".TB_PREF."pin_details.stock_id ,null, ' ', ".TB_PREF."pin_details.location)
