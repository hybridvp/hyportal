...
{
	$sql = "SELECT i.item_code AS kit_code, i.description AS kit_name, c.category_id AS cat_id, c.description AS cat_name, decode(sign(count(1)-1), -1, 0, 1) AS kit
			FROM
			".TB_PREF."item_codes i
			LEFT JOIN
			".TB_PREF."stock_category c
			ON i.category_id=c.category_id";
	$sql .=	" WHERE i.is_foreign<>1 AND i.item_code!=i.stock_id";
	if ($category != 0)
